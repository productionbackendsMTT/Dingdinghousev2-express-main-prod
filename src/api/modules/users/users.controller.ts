...
class UserController {
  ...
  async getCurrentUser(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const filteredPermissions = requestingUser.permissions
        .map((p) =>
          p.resource === Resource.ROLES && p.permission !== "rwx" ? null : p
        )
        .filter(Boolean);
      ...
      res
        .status(200)
        .json(successResponse(data, "User details retrieved successfully"));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getUserById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json(successResponse(user, "User retrieved successfully"));
    } catch (error) {
      next(error);
    }
  }
  ...
  async getUserReport(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json(successResponse(report, "User report generated successfully"));
    } catch (error) {
      next(error);
    }
  }
  ...
  async updateUserPermissions(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json(
          successResponse(updatedUser, "User permissions updated successfully")
        );
    } catch (error) {
      next(error);
    }
    ...
    try {
      ...
      res
        ...
        .json(
          successResponse(
            favouriteGames,
            "Favourite games retrieved successfully"
          )
        );
    } catch (error) {
      next(error);
  ...
  async updateFavouriteGames(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json(
          successResponse(updatedUser, "Favourite games updated successfully")
        );
    } catch (error) {
      next(error);
    }
