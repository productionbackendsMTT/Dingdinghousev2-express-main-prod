...
import { DefaultSlotGame } from './(Slots)/core/default.slot';
...
let currentGame: BaseSlotGame = new DefaultSlotGame({
  id: 'default',
  matrix: {
        "x": 5,
        "y": 3
...
app.get('/game', (req: Request, res: Response) => {
    const gameConfig = { id: 'default',
        matrix: { x: 0, y: 0 },
        linesApiData: [],
        linesCount: [],
        bets: [],
        Symbols: []} ;
    const game = new DefaultSlotGame(gameConfig);
...
app.get('/game/spin', (req: Request, res: Response) => {
    if (!currentGame) {
      currentGame = new DefaultSlotGame({id: 'default',
        matrix: { x: 0, y: 0 },
        linesApiData: [],
        linesCount: [],
        bets: [],
